#!/usr/bin/env node
// MemWeave Codex plugin -- PreToolUse hook (cross-platform Node).
//
// Codex's PreToolUse mirrors Claude Code's. We only react to
...
// pack and emit it as `additionalContext`. The Codex loader then
